...
def wrapped_ico_img(filename: str) -> Image:
    ico = extract_icon(filename=filename, size=IconSize.LARGE)
    img = win32_icon_to_image(ico,IconSize.LARGE)
    return img
...
wrapped_ico_img("C:\\Users\\Tardy\\AppData\\Roaming\\Zoom\\bin\\Zoom.exe").save("trial.png")